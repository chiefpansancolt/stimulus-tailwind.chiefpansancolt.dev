          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                A Tailwind inspired StimulusJS Library similiar to HeadlessUI but for frameworkless
                languages like Ruby on Rails, static HTML and others.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Get started</Button>
                <Button href="https://github.com/chiefpansancolt/stimulus-tailwind-components" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
